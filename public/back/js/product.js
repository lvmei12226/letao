$(function(){
    ...
    $('#fileupload').fileupload({
        ...
        // 每一张图片上传, 都会响应一次
            ...
            console.log(data);
            /*result
                :picAddr:"/upload/product/d111a490-3bf9-11e8-b151-2ffdf4b2a164.jpg"
                picName:"d111a490-3bf9-11e8-b151-2ffdf4b2a164.jpg"*/
            // 获取图片地址对象
            var picObj=data.result;
            // 获取图片地址
            var picAddr=picObj.picAddr;

            // 新得到的图片对象, 应该推到数组的最前面(unshift在数组最前面添加)
            ...
            // 需要将表单 picStatus 的校验状态, 置成 VALID有效（打勾）
            if(picArr.length === 3){
